...
CYAN='\033[1;36m'; MAGENTA='\033[1;35m'; RESET='\033[0m'; DIM='\033[2m'
...
if [[ "$EUID" -ne 0 ]]; then
    echo -e "${RED}ERROR: must run as root — use: sudo bash apply-hardening.sh${RESET}"
    exit 1
fi
...
# Generated by apply-hardening.sh
